...
|:---:|:---------:|:--------:|:----:|:-------:|:---------:|:------------------:|
| 1 | VGG-16-bn | 138M | X | 83.2% |LR=1e-4, Batch_size=64, Epochs=20| 60분 (3분/Epoch) |
| 2 | VGG-16-bn | 138M | O | 86.4% |LR=1e-4, Batch_size=64, Epochs=14| 190분 (13.5분/Epoch) |
...
| 5 | EfficientNet-B0 | 5.3M | X | 78.6% |LR=1e-3, Batch_size=32, Epochs=20| 35분 (1.75분/Epoch) |
| 6 | EfficientNet-B0 | 5.3M | O | 83.2% |LR=1e-3, Batch_size=64, Epochs=14| 140분 (10분/Epoch) |
...
| 2 | VGG-16    | 138M | O | 82.37% |LR=1e-4, Batch_size=64, Epochs=60 | 92분 (1.5분/Epoch)|
...
| 7 | VGG-16-bn | 138M | X | 89.71% |LR=1e-4, Batch_size=64, Epochs=60 | 112분 (1.9분/Epoch)|
